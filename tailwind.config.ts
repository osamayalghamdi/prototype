	...
	theme: {
		...
		extend: {
			colors: {
				...
				'stadium-primary': '#1e3a8a', // Deep trust blue
				'danger-zone': '#dc2626', // ISO-compliant emergency red
				'crowd-low': '#34d39980',
				'crowd-high': '#f59e0b80',
				'crowd-critical': '#ef444480',
				primary: {
			...
			animation: {
				...
				'checkmark-appear': 'checkmark-appear 0.3s ease-out',
				'stadium-spin': 'stadium-spin 1.5s linear infinite'
			},
			fontFamily: {
